<?php include 'pages/layout/header.html';?>
  ...
  <!-- Header Carousel -->
  <header id="myCarousel" class="carousel slide" data-interval=60000 pause= 'hover' data-wrap="false" cycle= false>
      <!-- Indicators -->
...
<ul>
	<li>An event that creates the perception that unauthorized collection, use or exposure of sensitive 	information may happen</li>
</ul>
...
In this initial phase, the database is not public and contributions are by invitation only, but eventually it will be publicly accessible and crowd-sourced to ensure broad coverage of privacy incidents.</p>
	</div>
